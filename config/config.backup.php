<?php
	...
	// Last Updated: 24th Aug 2011 @ 6:10 PM

	$GLOBALS['ISC_CFG']["isSetup"] = true;
	$GLOBALS['ISC_CFG']["Language"] = 'es';
	$GLOBALS['ISC_CFG']["AllowPurchasing"] = 1;
	$GLOBALS['ISC_CFG']["serverStamp"] = 'ISCEAIAAAAAAwCIExbjDERT4kNw7dnC9ZOkOQA';
	...
	$GLOBALS['ISC_CFG']["dbUser"] = 'mo000235_inter';
	$GLOBALS['ISC_CFG']["dbPass"] = 'nafuma83PE';
	$GLOBALS['ISC_CFG']["dbDatabase"] = 'mo000235_interspire';
	$GLOBALS['ISC_CFG']["tablePrefix"] = 'isc_';
	$GLOBALS['ISC_CFG']["StoreName"] = 'VivoenSale.com';
	$GLOBALS['ISC_CFG']["StoreAddress"] = 'Malabia 443';
	$GLOBALS['ISC_CFG']["LogoType"] = 'image';
	$GLOBALS['ISC_CFG']["StoreLogo"] = 'logo.png';
	$GLOBALS['ISC_CFG']["ShopPath"] = 'http://www.vivoensale.com';
	...
	$GLOBALS['ISC_CFG']["template"] = 'vivoensale';
	$GLOBALS['ISC_CFG']["SiteColor"] = 'red';
	...
	$GLOBALS['ISC_CFG']["InstallDate"] = 1308088410;
	...
	$GLOBALS['ISC_CFG']["HomeFeaturedProducts"] = 1;
	$GLOBALS['ISC_CFG']["HomeNewProducts"] = 3;
	$GLOBALS['ISC_CFG']["HomeBlogPosts"] = 10;
	$GLOBALS['ISC_CFG']["CategoryProductsPerPage"] = 1;
	...
	$GLOBALS['ISC_CFG']["AdminEmail"] = 'info@vivoensale.com';
	$GLOBALS['ISC_CFG']["OrderEmail"] = 'info@vivoensale.com';
	...
	// Checkout Settings
	$GLOBALS['ISC_CFG']["CheckoutMethods"] = 'checkout_mercadopago2';
  ...
  2 => 'Store Credit',
	...
	$GLOBALS['ISC_CFG']['GiftCertificateMinimum'] = 50;
	$GLOBALS['ISC_CFG']['GiftCertificateMaximum'] = 100;
	...
	$GLOBALS['ISC_CFG']['OrderStatusNotifications'] = '7';

	$GLOBALS['ISC_CFG']['AddonModules'] = 'addon_permissioncheck,addon_googleadwords';
	...
	$GLOBALS['ISC_CFG']['AffiliateConversionTrackingCode'] = '<!-- Google Code for Conversi&oacute;n para Analytics Conversion Page -->
<script type="text/javascript">
/* <![CDATA[ */
var google_conversion_id = 962850785;
var google_conversion_language = "es";
var google_conversion_format = "2";
var google_conversion_color = "ffffff";
var google_conversion_label = "-ehgCI_BnwMQ4d-PywM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/962850785/?label=-ehgCI_BnwMQ4d-PywM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>';
	...
	$GLOBALS['ISC_CFG']['CategoryDisplayMode'] = 'list';
  ...
  6 => 'storeComplete',
	...
	$GLOBALS['ISC_CFG']['SearchOptimisation'] = 'like';

	// Abandon Orders
	$GLOBALS['ISC_CFG']['AbandonOrderLifetime'] = '30';

	// Product Image Settings
	$GLOBALS['ISC_CFG']['ProductImagesStorewideThumbnail_width'] = 440;
	$GLOBALS['ISC_CFG']['ProductImagesStorewideThumbnail_height'] = 265;
	$GLOBALS['ISC_CFG']['ProductImagesStorewideThumbnail_timeChanged'] = 1313444223;
	$GLOBALS['ISC_CFG']['ProductImagesProductPageImage_width'] = 440;
	$GLOBALS['ISC_CFG']['ProductImagesProductPageImage_height'] = 265;
	$GLOBALS['ISC_CFG']['ProductImagesProductPageImage_timeChanged'] = 1313444223;
	$GLOBALS['ISC_CFG']['ProductImagesGalleryThumbnail_width'] = 225;
	$GLOBALS['ISC_CFG']['ProductImagesGalleryThumbnail_height'] = 150;
	$GLOBALS['ISC_CFG']['ProductImagesGalleryThumbnail_timeChanged'] = 1308154087;
	...
	$GLOBALS['ISC_CFG']['ProductImagesImageZoomEnabled'] = 0;
	...
	$GLOBALS['ISC_CFG']["StartingOrderNumber"] = 428;
	...
	$GLOBALS['ISC_CFG']['taxDefaultCountry'] = '10';
  ...
  4 => 'android',
	...
	$GLOBALS['ISC_CFG']['FacebookLikeButtonAdminIds'] = '100000295286263';
