<?php
	...
	// Last Updated: 5th Sep 2011 @ 10:04 PM

	$GLOBALS['ISC_CFG']["isSetup"] = true;
	$GLOBALS['ISC_CFG']["Language"] = 'es';
	$GLOBALS['ISC_CFG']["AllowPurchasing"] = 1;
	$GLOBALS['ISC_CFG']["serverStamp"] = 'ISCEAIAAAAAAwCIE451/9ZxD7TmMVjtqO+lYF0';
	...
	$GLOBALS['ISC_CFG']["dbDatabase"] = 'vivonew';
	...
	$GLOBALS['ISC_CFG']["ShopPath"] = 'http://localhost/ves/trunk/';
...
<img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/962850785/?label=-ehgCI_BnwMQ4d-PywM&amp;guid=ON&amp;script=0"/>
  ...
  6 => 'storeComplete',
	...
	$GLOBALS['ISC_CFG']["StartingOrderNumber"] = 999999;
