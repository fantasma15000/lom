<?php
	...
	class ISC_CATEGORY
	{
		...
		public function SetCategoryData()
		{
			...
			if(!$this->_catproducts){
				$aditionalWhere=" and (publish_start < now() and publish_end > now() )";
				$this->LoadProductsForPage($aditionalWhere);
			}
		}
		...
		public function LoadProductsForPage($aditionalWhere=null)
		{
			...
			$query = "
				SELECT
					p.*, b.brandname as brandName, b.brandinfo as brandInfo, b.brandgmap as brandMap, b.brandimagefile as BrandImageFile, b.brandlink as brandLink,
