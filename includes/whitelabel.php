...
$GLOBALS['ISC_CFG']['TemplatePoweredByLines'] = array(
	0 => 'Desarrollado por <a href="http://www.sourcingup.com" target="_blank" class="PoweredBy">SourcingUp.</a>',
	1 => '<a href="http://www.sourcingup.com" target="_blank" class="PoweredBy">Online store software</a> by Interspire',
	2 => '<a href="http://www.sourcingup.com" target="_blank" class="PoweredBy">Shopping cart</a> by Interspire',
	3 => '<a href="http://www.sourcingup.com" target="_blank" class="PoweredBy">E-commerce software by Interspire</a>',
	4 => '<a href="http://www.sourcingup.com" target="_blank" class="PoweredBy">Online shop software</a> by Interspire',
);
