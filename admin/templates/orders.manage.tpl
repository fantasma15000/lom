		...
		<td class="Intro">
			...
			<td class="Intro" valign="top">
				...
				{% else %}
					...
					<input type="button" onclick="javascript:window.location='index.php?ToDo=viewOrders&ToDo=ocasa&type=sucursal'" value="{% lang 'ExportTheseOrdersSucursal' %}" class="SmallButton" />
					<input type="button" onclick="javascript:window.location='index.php?ToDo=viewOrders&ToDo=ocasa&type=domicilio'" value="{% lang 'ExportTheseOrdersDomicilio' %}" class="SmallButton" />
				{% endif %}
				<br />
