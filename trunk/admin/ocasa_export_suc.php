<?php
	...
	mysql_select_db("vivonew");	
		...
		$query = "SELECT o.orderid as orderid, method, module, ordprodname as producttitle,ordprodqty as bultos,c.custconfirstname as firstname,
				...
				where ordstatus=9 and module = 12";		
//echo $query;die();
		...
		if(mysql_num_rows($result)!=0){
			...
			header ("Content-Disposition: attachment; filename=ordenes_export_sucursal_".date("d_m_Y").".xls" );
			header ("Content-Description: PHP/INTERBASE Generated Data" );
				...
				xlsBOF(); 
					...
					while($rows = mysql_fetch_object($result)) {	
						...
						$bultos = $rows->bultos;
						$peso = $rows->peso;
						$observaciones = $dni . " ; " .utf8_encode($rows->producttitle);
