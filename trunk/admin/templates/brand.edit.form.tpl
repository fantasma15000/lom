	...
	<tr>
		<td>
			<table class="Panel">
				...
				<tr>
					<td class="FieldLabel">
						<span class="Required">*</span>&nbsp;{% lang 'BrandInfo' %}:
					</td>
					<td>
						<textarea name="brandInfo" id="brandInfo" class="Field400">{{ BrandInfo|safe }}</textarea>
					</td>
				</tr>				
				<tr>
					<td class="FieldLabel">
						<span class="Required">*</span>&nbsp;{% lang 'BrandLink' %}:
					</td>
					<td>
						<input type="text" name="brandLink" id="brandLink" class="Field400" value="{{ BrandLink|safe }}">
					</td>
				</tr>
				<tr>
					<td class="FieldLabel">
						<span class="Required">*</span>&nbsp;{% lang 'BrandMap' %}:
					</td>
					<td>
						<textarea name="brandMap" id="brandMap" class="Field400">{{ BrandMap|safe }}</textarea>
					</td>
				</tr>
				<tr>
					<td class="FieldLabel">
