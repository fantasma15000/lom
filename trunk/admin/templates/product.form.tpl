		...
		<td>
			...
			<div id="div0" style="padding-top: 10px;">
				...
				<table width="100%" class="Panel">
					...
					<tr>
						<td class="FieldLabel">
							<span class="Required">*</span>&nbsp;{% lang 'ProductOcasaName' %}:
						</td>
						<td>
							<input type="text" id="prodocasaname" name="prodocasaname" class="Field400" value="{{ prodocasaname|safe }}">
						</td>
					</tr>					
					<tr>
						<td class="FieldLabel">
					...
					<tr>
						<td class="FieldLabel">
							<span class="Required">*</span>&nbsp;{% lang 'PubFromTo' %}:
						</td>
						<td>
							{% lang 'PubFromTo_from' %}&nbsp;&nbsp;<input type="text" id="prodPDate_from" name="prodPDate_from" class="Field120" value="{{ prodPDate_from|safe }}">
							{% lang 'PubFromTo_to' %}&nbsp;&nbsp;<input type="text" id="prodPDate_to" name="prodPDate_to" class="Field120" value="{{ prodPDate_to|safe }}">
						</td>
					</tr>					
					
						<tr>
						<td class="FieldLabel">
							<span class="Required">*</span>&nbsp;{% lang 'Validez' %}:
						</td>
						<td>							
							&nbsp;&nbsp;<input type="text" id="Validez" name="Validez" class="Field120" value="{{ Validez|safe }}">
						</td>
					</tr>
				</table>
				<table width="100%" class="Panel">
				...
				<table width="100%" class="Panel">
					<tr>
					  <td class="Heading2" colspan=2>{% lang 'ProductMailDescription' %}</td>
					</tr>
					<tr>
						<td colspan="2">
							<textarea cols="235" rows="10" name="ProductMailDescription" id="ProductMailDescription">{{ ProductMailDescription|safe }}</textarea>
						</td>
					</tr>
				</table>
				<table width="100%" class="Panel">
				...
				<table width="100%" class="Panel " id="shipping_table">
					<tr>
					...
					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp;&nbsp;{% lang 'FixedShippingCost2' %}:
						</td>
						<td>
							{{ CurrencyTokenLeft|safe }} <input type="text" id="prodFixedCost2" name="prodFixedCost2" class="Field80" style="width:70px; text-align: right;" value="{{ ProdFixedShippingCost2|safe }}" onkeyup="document.getElementById('prodFreeShipping2').checked=false"> {{ CurrencyTokenRight|safe }}
							<img onmouseout="HideHelp('d21');" onmouseover="ShowHelp('d21', '{% lang 'FixedShippingCost2' %}', '{% lang 'FixedShippingCostHelp2' %}')" src="images/help.gif" width="24" height="16" border="0">
							<div style="display:none" id="d21"></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="checkbox" id="prodFreeShipping" name="prodFreeShipping" value="1" {{ FreeShipping|safe }} onclick="if(this.checked) { document.getElementById('prodFixedCost').value='0';document.getElementById('prodFixedCost2').value='0';document.getElementById('prodFixedCost277').value='0'; }"> <label for="prodFreeShipping">{% lang 'YesFreeShipping' %}</label>
					...
					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp;&nbsp;{% lang 'ShippingAllowed' %}:
						</td>
						<td>
							<input type="radio" name="ShippingAllowed" id="ShippingAllowed0" value="0" {% if ShippingAllowed == '0' %}checked="checked"{% endif %}>
							<label for="ShippingAllowed0">{% lang 'ShippingAllowed0' %}</label>						
							<input type="radio" name="ShippingAllowed" id="ShippingAllowed1" value="1" {% if ShippingAllowed == '1' %}checked="checked"{% endif %}>
							<label for="ShippingAllowed1">{% lang 'ShippingAllowed1' %}</label>							
							<input type="radio" name="ShippingAllowed" id="ShippingAllowed2" value="2" {% if ShippingAllowed == '2' %}checked="checked"{% endif %}>
							<label for="ShippingAllowed2">{% lang 'ShippingAllowed2' %}</label>
							<input type="radio" name="ShippingAllowed" id="ShippingAllowed3" value="3" {% if ShippingAllowed == '3' %}checked="checked"{% endif %}>
							<label for="ShippingAllowed3">{% lang 'ShippingAllowed3' %}</label>
							
							<img onmouseout="HideHelp('d30');" onmouseover="ShowHelp('d30', '{% lang 'ShippingAllowed' %}', '{% lang 'ShippingAllowedHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
							<div style="display:none" id="d30"></div>
						</td>
					</tr>
