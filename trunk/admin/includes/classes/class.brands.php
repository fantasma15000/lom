	...
	class ISC_ADMIN_BRANDS extends ISC_ADMIN_BASE
	{
		...
		public function EditBrand($MsgDesc = "", $MsgStatus = "")
		{
			if(isset($_GET['brandId'])) {
				...
				if($row = $GLOBALS["ISC_CLASS_DB"]->Fetch($result)) {
					...
					$GLOBALS['BrandInfo'] = isc_html_escape($row['brandinfo']);
					$GLOBALS['BrandMap'] = isc_html_escape($row['brandgmap']);
					$GLOBALS['BrandLink'] = isc_html_escape($row['brandlink']);
		...
		public function SaveEditedBrand()
		{
			if(isset($_POST['brandName'])) {
				...
				$brandMap = $_POST['brandMap'];
				$brandInfo = $_POST['brandInfo'];
				$brandLink = $_POST['brandLink'];
