...
function showshipping(option)
{

  if (option==1)
	{
		document.getElementById("shippinginfo").style.display = 'none';
		document.getElementById("shippinginfo1").style.display = 'block';
	}
  else if(option == 2)
	{
		document.getElementById("shippinginfo").style.display = 'block';
		document.getElementById("shippinginfo1").style.display = 'none';
	} else if(option == 0){
		document.getElementById("shippinginfo").style.display = 'none';
		document.getElementById("shippinginfo1").style.display = 'none';
	}
...
function validateShipMethForm(){	
	if(document.getElementById('ShippingType').value == 1){
		if(document.getElementById('ShippingSucursal').value == 0){
			alert('Elija una sucursal.');
			return false;
		}
		if(document.getElementById('dniparasucursal').value == ''){
			alert('Ingrese su DNI.');
			return false;
		}	
		if(document.getElementById('telparasucursal').value == ''){
			alert('Ingrese un Telefono.');
			return false;
		}			
	} else if(document.getElementById('ShippingType').value == 0){
		alert('Debe elegir al menos un metodo de pago.');
		return false;
	}
	return true;
}